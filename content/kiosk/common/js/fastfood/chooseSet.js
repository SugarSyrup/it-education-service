import {OPTION, SETCATEGORYNUM, SETOPTIN, SINGLEOPTION, SINGLECART, SUBJECTNUM ,QUESTIONOPTION, NOQUESTION} from '/content/kiosk/common/js/utils/key.js';
...
function set(i) {
  ...
  localStorage.setItem(SETOPTIN, "set");
