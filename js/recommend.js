...
mobile_wrapper.append(Lecture("휴대폰 사용 (기초)","안드로이드 휴대폰 기본 사용 및 설정방법 (기초)",["#모바일"],false, "./content/phone"))
mobile_wrapper.append(Lecture("카카오톡 사용 (기초)","카카오톡 기본 기능및 설정에 대한 설명.",["#모바일"],false, "./content/kakao"))
